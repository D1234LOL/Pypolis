...
# idioma del juego:
#define config.languages = ["es", "en"]
# para el tema predeterminado
#define config.default_theme = "default"
...
init python:
    # Configura el tiempo para Auto-Forward Mode en segundos por palabra
    preferences.afm_time = 0.5  # Cambia 0.5 al valor que desees
...
define config.save_directory = "Pypolis-1730135116"
