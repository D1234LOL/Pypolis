...
init python:
    ...
    def change_language(lang):
        ...
        renpy.restart_interactive()

# Modificar el menú de Configuración
screen preferences():
    tag menu

    use game_menu(_("Opciones"), scroll="viewport"):
        # Opciones estándar de Ren'Py
        vbox:
            # Idioma
            label _("Idioma / Language")
            textbutton "Español" action Function(change_language, "es")
            textbutton "English" action Function(change_language, "en")
            hbox:
                box_wrap True
            vbox:
